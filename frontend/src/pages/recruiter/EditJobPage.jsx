...
const EditJobPage = () => {
  ...
  useEffect(() => {
    const fetchJob = async () => {
      ...
      try {
        ...
        setError("Failed to retrieve job details. Listing might not exist or you lack authorization.");
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const msg = err.response?.data?.message || "Failed to update job opening. Please check your data.";
      setError(msg);
    } finally {
      setSubmitting(false);
    }
  ...
  if (loading) return <LoadingSpinner message="Retrieving job posting details..." />;
      ...
      <div className="row justify-content-center">
        <div className="col-lg-8 col-12">
          ...
          <div className="mb-4">
            ...
            <h1 className="fw-bold font-heading display-5 mt-2 mb-1">Edit Job Listing</h1>
            <p className="text-secondary mb-0">Modify and update your career or internship listing details.</p>
          </div>
